...
function createMarkup(root) {
  root.innerHTML = `
    <section class="panel" hidden>
      ...
      <div class="actions"><button type="button" data-send="resumidor"><span class="action-icon">R</span>Resumir selección</button><button type="button" data-transcript="clases"><span class="action-icon">T</span>Enviar transcripción</button><button type="button" data-send="multi-profesor" data-professor="Inglés C1"><span class="action-icon">EN</span>Practicar inglés</button><button type="button" data-send="multi-profesor" data-professor="Tecnología"><span class="action-icon">TI</span>Analizar tecnología</button><button type="button" data-send="multi-profesor" data-professor="Música"><span class="action-icon">MU</span>Profesor de música</button><button type="button" data-send="multi-profesor" data-professor="Matemáticas"><span class="action-icon">MA</span>Profesor de matemáticas</button><button type="button" data-send="multi-profesor" data-professor="Física"><span class="action-icon">FI</span>Profesor de física</button><button type="button" data-send="legal"><span class="action-icon">LG</span>Análisis legal</button><button type="button" data-send="visuales"><span class="action-icon">V</span>Crear recurso visual</button><button type="button" class="wide" data-send="codigo"><span class="action-icon">C</span>Revisar código</button></div>
...
function ensureBubble() {
  ...
  root.querySelectorAll("[data-send]").forEach((button) => {
    button.addEventListener("click", async () => {
      ...
      const payload = { ...pagePayload(selectedText, "selection", professor ? `${adapter.name}: ${professor}` : adapter.name), requestedTool: button.dataset.send, consent: true };
